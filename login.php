...
if(isset($_POST['login'])) {
    ...
    $sql ="SELECT id, Status FROM tblblooddonars WHERE EmailId=:email and Password=:password";
...
<body>
    ...
    <section class="hero-banner">
        <div class="container">
            <h1>Donor Login</h1>
            <p class="lead">Access your donor account to manage your profile and requests</p>
        </div>
    </section>
            ...
            <div class="login-card">
                ...
                <form action="#" method="post" name="login">
                    ...
                    <div class="login-links">
                        ...
                        <!-- Uncomment if you implement password recovery
                        <p>
