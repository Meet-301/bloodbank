...
if (isset($_POST['submit'])) {
    ...
    if ($query->rowCount() == 0) {
        $sql = "INSERT INTO tblblooddonars(FullName, MobileNumber, EmailId, Age, Gender, BloodGroup, BloodUnits, latitude, longitude, Message, status, Password, profile_image) 
                VALUES(:fullname, :mobile, :email, :age, :gender, :bloodgroup, :bunits, :lat, :lng, :message, :status, :password, :profile_image)";
...
<head>
    ...
    <title>Become a Donor | Life Savior</title>
    <meta name="description" content="Join our community of life-savers by becoming a blood donor">
...
<body>
    ...
    <section class="hero-banner">
        <div class="container">
            ...
            <p class="lead">Join our community of life-savers and help make a difference</p>
        </div>
    </section>
    ...
    <section class="signup-section">
        <div class="container">
            <div class="signup-card">
                <h2 class="section-title">Create Your Donor Account</h2>
                ...
                <form action="#" method="post" name="signup" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="bunits" class="form-label required-field">Blood Units</label>
                            <input type="number" name="bunits" min="10" max="150" class="form-control" placeholder="Enter available blood units"
                                required>
                        </div>
                    </div>
